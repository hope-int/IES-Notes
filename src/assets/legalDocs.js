...
Depending on the task (e.g., complex coding vs. quick chatting), we route your queries to highly capable models including **NVIDIA Nemotron 3 Nano Omni**, **Poolside Laguna XS.2**, **Llama-3.3-70B**, **Llama-3.1-8B**, **Mixtral-8x7B**, and **Gemma2-9B**. We utilize dynamic routing to ensure the best performance.
